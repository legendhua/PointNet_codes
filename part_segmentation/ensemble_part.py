...
import provider
import pointnet_part_seg_ensemble as model

parser = argparse.ArgumentParser()
parser.add_argument('--first_model_path', default='ensemble_log/original/epoch_190.ckpt', help='Model checkpoint path')
parser.add_argument('--second_model_path', default='ensemble_log/shallow1/epoch_200.ckpt', help='Model checkpoint path')
...
def ensemble_part():                
    ...
    seg_pred_res_val = (first_seg_val+second_seg_val)/2
